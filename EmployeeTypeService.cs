...
namespace EmployeeManager.BusinessLayer
{
    ...
    /// in the data source for EmployeeTypes.
    /// </summary>
    public partial class EmployeeTypeService : EmployeesServiceBase
    {
        /// <summary>
        /// Empty, static constructor to prohibit direct allocation of this class.
        /// </summary>
        static EmployeeTypeService() { }
        ...
        /// <see cref="T:EmployeeManager.BusinessLayer.EmployeeTypeService" />.
        /// </summary>
        public static EmployeeTypeService Instance { get; } =
            new EmployeeTypeService();
        
        /// <summary>
        /// Adds the data specified by the
        /// <see cref="T:EmployeeManager.BusinessLayer.EmployeeType" /> entity
        ...
        /// the Add operation.
        /// </remarks>
        public int Add(EmployeeType newEntity, Func<EmployeeType, bool> existingItemPredicate = null)
        {
            ...
            {
                var foundEntity = GetAll().Cast<EmployeeType>().FirstOrDefault(existingItemPredicate);
                idOfExistingRow = foundEntity == null ? -1 : foundEntity.EmployeeTypeID;
            }
            ...
            try
            {
                UnitOfWork.EmployeeTypes.Add(newEntity);
                if (UnitOfWork.Save() > 0)
                    result = newEntity.EmployeeTypeID;
            }
            catch (Exception ex)
            {
                result = -1;
        ...
        /// <see
        ///     cref="M:EmployeeManager.BusinessLayer.EmployeeTypeService.GetById" />
        ...
        /// <see cref="T:EmployeeManager.BusinessLayer.EmployeeType" /> that
        ...
        /// performs the Delete operation.
        /// </remarks>
        public int Delete(EmployeeType entityToDelete)
        {
            var result = -1;
            ...
            try
            {
                UnitOfWork.EmployeeTypes.Delete(entityToDelete);
        ...
        /// <summary>
        /// Given the name of a EmployeeType, looks up its database ID.
        /// </summary>
        ...
        /// </param>
        /// <returns>EmployeeType ID, or -1 if not found.</returns>
        public int FindEmployeeTypeId(Func<EmployeeType, bool> searchPredicate)
        {
            var result = -1;
            ...
            try
            {
                ...
                if (GetAll().Cast<EmployeeType>().All(x => !searchPredicate(x)))
                    return -1;
                ...
                if (entityFound != null)
                    result = entityFound.EmployeeTypeID;
            }
            catch (Exception ex)
            {
                result = -1;
        ...
        public IBindingList GetAll()
        {
            ...
            try
            {
                result = UnitOfWork.EmployeeTypes.GetAll();
            }
            catch (Exception ex)
            {
                result = new BindingList<EmployeeType>();
        ...
        /// <see cref="T:EmployeeManager.BusinessLayer.EmployeeType" /> containing
        ...
        public EmployeeType GetById(int id)
        {
            ...
            try
            {
                entity = UnitOfWork.EmployeeTypes.GetById(id);
            }
            catch(Exception ex)
            {
                entity = null;
