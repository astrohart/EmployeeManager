...
{
    /// <summary>
    ///     Tests whether the data source that undergirds the Employees
    ///     is connected and/or available.
    /// </summary>
    public static class EmployeesConnectionTester
    {
        /// <summary>
        ///     Initializes the one and only static instance of this class.
        /// </summary>
        static EmployeesConnectionTester() => ResetDiagnosticProperties();
        ...
        public static bool IsDatabaseOnline(string connectionString)
        {
            ...
            using (var db = new EmployeesEntities(connectionString))
            {
                result = TestConnectionToDatabase(db);
            }
        ...
        ///     <see
        ///         cref="P:EmployeeManager.BusinessLayer.EmployeesConnectionTester.LastUsedConnectionString" />
        ...
        ///     and
        ///     <see
        ///         cref="P:EmployeeManager.BusinessLayer.EmployeesConnectionTester.LastError" />
