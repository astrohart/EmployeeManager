...
namespace EmployeeManager.BusinessLayer
{
    ...
    public partial interface IEmployeesService
    {
        ...
        /// <summary>Initializes the underlying connection to the data source.  Callers must pass a reference to an instance of an object that implements the <see cref="T:EmployeeManager.BusinessLayer.IEmployeesUnitOfWork"/> interface in for the <paramref name="unitOfWorkObject" /> parameter.  This object is utilized to access the underlying data source.
        /// </summary><param name="unitOfWorkObject">(Required.) Reference to an instance of an object that implements the <see cref="T:EmployeeManager.BusinessLayer.IEmployeesUnitOfWork"/> interface</param>
        void DoInitialize(
