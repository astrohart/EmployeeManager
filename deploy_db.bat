...
if exist "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data" rd /S /Q "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data" >nul 2>nul
if not exist "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data" mkdir "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data" >nul 2>nul
if exist "%~dp0Employees.mdf" copy /Y "%~dp0Employees.mdf" "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data\" >nul 2>nul
if exist "%~dp0Employees_log.ldf" copy /Y "%~dp0Employees_log.ldf" "%PROGRAMDATA%\xyLOGIX, LLC\EmployeeManager\Data\" >nul 2>nul
